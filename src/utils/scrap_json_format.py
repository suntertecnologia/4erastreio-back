...
dados_brutos_simulados = {
    ...
    "remetente": {
        "nome": "HUNTER DOUGLAS TOLDOS DO BRASIL LTDA",
        "cnpj": "48.775.191/0001-90",
    },
    "destinatario": {
        "nome": "QUATRO ESTACOES COM E SERV DE DECORACOES LTDA",
        "cnpj": "48.775.191/0001-90",
    },
    "ocorrencias": [
...
def map_scrap_json(dados_brutos: dict, nome_transportadora: str) -> dict:
    ...
    info_gerais = {
        ...
        "data_postagem": dados_brutos.get(
            "data_emissao_doc"
        ),  # Assumindo que emissão do doc é a data de postagem
