...
from src.utils.normalize_scrap_data import normalize_braspress, normalize_jamef, normalize_viaverde, normalize_accert
...
def export_data(company: str,cnpj: str, nota_fiscal: str):
    async def get_tracking_data(company: str,cnpj: str, nota_fiscal: str):
        ...
        match company:
            ...
            case "viaverde":
                raw_data = await rastrear_viaverde("pedidos.quatroestacoes","4Edecoracoes", nota_fiscal) # Login e senha fixos por enquanto
                if raw_data and raw_data.get('status') == 'sucesso':
